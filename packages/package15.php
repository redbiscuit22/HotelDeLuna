...
$package = [];
$query = "SELECT id, package_name, price, description FROM packages WHERE id = '15'";
...
// Set availability (assuming Presidential Villa Suite is available for this example)
$packageAvailability = [];
...
<head>
   ...
   <title>Presidential Villa Suite - Package Details</title>
...
<body>
   ...
   <section class="home-packages">
      <h1 class="heading-title">Presidential Villa Suite Details</h1>
      
      <!-- Image Slider -->
      <?php if (!empty($package)): ?>
         <div class="swiper-container">
            <div class="swiper-wrapper">
               <div class="swiper-slide"><img src="../images/room-15.jpg" alt="Presidential Villa Suite"></div>
               <div class="swiper-slide"><img src="../images/villa-living.jpg" alt="Living Area"></div>
               <div class="swiper-slide"><img src="../images/villa-dining.jpg" alt="Dining Area"></div>
               <div class="swiper-slide"><img src="../images/jacuzzi.jpg" alt="Jacuzzi"></div>
            </div>
         ...
         <div class="package-details">
            ...
            <ul>
               <li>Bed Type: California King bed</li>
               <li>Occupancy: Up to 6 persons</li>
               <li>Amenities: Living area, Dining table, Butler service, Jacuzzi</li>
            </ul>

            <!-- Inclusions and Ongoing Promotions -->
            <h4>Inclusions and Ongoing Promotions</h4>
            <ul>
               <li>Complimentary private chef dinner</li>
               <li>Free limousine service</li>
            </ul>
