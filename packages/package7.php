...
$package = [];
$query = "SELECT id, package_name, price, description FROM packages WHERE id = '7'";
...
// Set availability (assuming Sunset Pavilion is available for this example)
$packageAvailability = [];
...
<head>
   ...
   <title>Sunset Pavilion - Package Details</title>
...
<body>
   ...
   <section class="home-packages">
      <h1 class="heading-title">Sunset Pavilion Details</h1>
      
      <!-- Image Slider -->
      <?php if (!empty($package)): ?>
         <div class="swiper-container">
            <div class="swiper-wrapper">
               <div class="swiper-slide"><img src="../images/room-7.jpg" alt="Sunset Pavilion Room"></div>
               <div class="swiper-slide"><img src="../images/sunset-view.jpg" alt="Sunset View"></div>
               <div class="swiper-slide"><img src="../images/lounge-area.jpg" alt="Outdoor Lounge Area"></div>
               </div>
         ...
         <div class="package-details">
            ...
            <ul>
               <li>Bed Type: Twin beds or 1 Queen</li>
               <li>Occupancy: 2 adults</li>
               <li>Amenities: Sunset View, Outdoor lounge area, Air conditioning</li>
            </ul>
            ...
            <ul>
               ...
               <li>Live music night access</li>
               <li>Free beach mats</li>
            </ul>
