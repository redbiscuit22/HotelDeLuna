...
// Fetch specific package from database (using 'packages' table as per prior context)
$package = [];
$query = "SELECT id, package_name, price, description FROM packages WHERE id = '2'";
...
// Set availability (assuming Ocean Breeze Deluxe is available for this example)
$packageAvailability = [];
...
<head>
   ...
   <title>Ocean Breeze Deluxe - Package Details</title>
...
<body>
   ...
   <section class="home-packages">
      <h1 class="heading-title">Ocean Breeze Deluxe Details</h1>
      
      <!-- Image Slider -->
      <?php if (!empty($package)): ?>
         <div class="swiper-container">
            <div class="swiper-wrapper">
               <div class="swiper-slide"><img src="../images/room-2.jpg" alt="Ocean Breeze Deluxe Room"></div>
               <div class="swiper-slide"><img src="../images/balcony-2.jpg" alt="Ocean Breeze Deluxe Balcony"></div>
               <div class="swiper-slide"><img src="../images/bathroom-2.jpg" alt="Ocean Breeze Deluxe Bathroom"></div>
            </div>
         ...
         <div class="package-details">
            ...
            <ul>
               <li>Bed Type: Queen-size bed</li>
               <li>Occupancy: 2 adults</li>
               <li>Amenities: Sea-view Balcony, Air Conditioning, Flat Screen TV, Coffee Maker</li>
            </ul>
            ...
            <ul>
               <li>Welcome drink</li>
               <li>Free sunset cruise (1 hour)</li>
               <li>15% discount on seafood dining</li>
