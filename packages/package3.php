...
$package = [];
$query = "SELECT id, package_name, price, description FROM packages WHERE id = '3'";
...
// Set availability (assuming Bamboo Haven is available for this example)
$packageAvailability = [];
...
<head>
   ...
   <title>Bamboo Haven - Package Details</title>
...
<body>
   ...
   <section class="home-packages">
      <h1 class="heading-title">Bamboo Haven Details</h1>
      
      <!-- Image Slider -->
      <?php if (!empty($package)): ?>
         <div class="swiper-container">
            <div class="swiper-wrapper">
               <div class="swiper-slide"><img src="../images/bamboo-room.jpg" alt="Bamboo Haven Room"></div>
               <div class="swiper-slide"><img src="../images/garden-view.jpg" alt="Garden View"></div>
               <div class="swiper-slide"><img src="../images/bamboo-furniture.jpg" alt="Bamboo Furniture"></div>
               </div>
         ...
         <div class="package-details">
            ...
            <ul>
               <li>Bed Type: Bamboo-framed queen bed</li>
               <li>Occupancy: 2 adults</li>
               <li>Amenities: Eco-friendly toiletries, Bamboo furniture, Air Cooler, Garden View</li>
            </ul>

            <!-- Inclusions and Promotions -->
            <h4>Inclusions and Ongoing Promotions</h4>
            <ul>
               <li>Free guided nature walk</li>
               <li>Complimentary organic breakfast</li>
               <li>Reusable water bottles provided</li>
            </ul>
