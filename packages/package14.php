...
$package = [];
$query = "SELECT id, package_name, price, description FROM packages WHERE id = '14'";
...
// Set availability (assuming Celestial Dream Suite is available for this example)
$packageAvailability = [];
...
<head>
   ...
   <title>Celestial Dream Suite - Package Details</title>
...
<body>
   ...
   <section class="home-packages">
      <h1 class="heading-title">Celestial Dream Suite Details</h1>
      
      <!-- Image Slider -->
      <?php if (!empty($package)): ?>
         <div class="swiper-container">
            <div class="swiper-wrapper">
               <div class="swiper-slide"><img src="../images/room-14.jpg" alt="Celestial Dream Suite"></div>
               <div class="swiper-slide"><img src="../images/galaxy-lights.jpg" alt="Galaxy Lights"></div>
               <div class="swiper-slide"><img src="../images/telescope.jpg" alt="Stargazing Telescope"></div>
            </div>
         ...
         <div class="package-details">
            ...
            <ul>
               ...
               <li>Amenities: Projector ceiling, Galaxy lights, Smart automation</li>
            </ul>

            <!-- Inclusions and Ongoing Promotions -->
            <h4>Inclusions and Ongoing Promotions</h4>
            <ul>
               <li>Free stargazing telescope use</li>
               <li>Welcome champagne</li>
               <li>15% off room service</li>
            </ul>
