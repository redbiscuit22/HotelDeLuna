...
$package = [];
$query = "SELECT id, package_name, price, description FROM packages WHERE id = '8'";
...
// Set availability (assuming Zen Garden Room is available for this example)
$packageAvailability = [];
...
<head>
   ...
   <title>Zen Garden Room - Package Details</title>
...
<body>
   ...
   <section class="home-packages">
      <h1 class="heading-title">Zen Garden Room Details</h1>
      
      <!-- Image Slider -->
      <?php if (!empty($package)): ?>
         <div class="swiper-container">
            <div class="swiper-wrapper">
               <div class="swiper-slide"><img src="../images/room-8.jpg" alt="Zen Garden Room"></div>
               <div class="swiper-slide"><img src="../images/garden-view.jpg" alt="Garden View"></div>
               <div class="swiper-slide"><img src="../images/shoji-screens.jpg" alt="Shoji Screens"></div>
               </div>
         ...
         <div class="package-details">
            ...
            <ul>
               <li>Bed Type: Japanese futon or Queen</li>
               <li>Occupancy: 2 adults</li>
               <li>Amenities: Garden view, Shoji screens, Air purifier, Tea set</li>
            </ul>
            ...
            <ul>
               ...
               <li>Free matcha tea kit</li>
               <li>Complimentary aromatherapy oil</li>
            </ul>
