...
$package = [];
$query = "SELECT id, package_name, price, description FROM packages WHERE id = '13'";
...
// Set availability (assuming Adventure Pod Room is available for this example)
$packageAvailability = [];
...
<head>
   ...
   <title>Adventure Pod Room - Package Details</title>
...
<body>
   ...
   <section class="home-packages">
      <h1 class="heading-title">Adventure Pod Room Details</h1>
      
      <!-- Image Slider -->
      <?php if (!empty($package)): ?>
         <div class="swiper-container">
            <div class="swiper-wrapper">
               <div class="swiper-slide"><img src="../images/room-13.jpg" alt="Adventure Pod Room"></div>
               <div class="swiper-slide"><img src="../images/secure-locker.jpg" alt="Secure Locker"></div>
               <div class="swiper-slide"><img src="../images/adventure-kit.jpg" alt="Adventure Kit"></div>
            </div>
         ...
         <div class="package-details">
            ...
            <ul>
               ...
               <li>Occupancy: 1 adult</li>
               <li>Amenities: Compact design, Charging ports, Secure locker</li>
            </ul>

            <!-- Inclusions and Ongoing Promotions -->
            <h4>Inclusions and Ongoing Promotions</h4>
            <ul>
               <li>Free locker use</li>
               <li>Adventure kit</li>
               <li>Discount on zipline and wall climbing</li>
            </ul>
