...
$package = [];
$query = "SELECT id, package_name, price, description FROM packages WHERE id = '6'";
...
// Set availability (assuming Urban Loft is available for this example)
$packageAvailability = [];
...
<head>
   ...
   <title>Urban Loft - Package Details</title>
...
<body>
   ...
   <section class="home-packages">
      <h1 class="heading-title">Urban Loft Details</h1>
      
      <!-- Image Slider -->
      <?php if (!empty($package)): ?>
         <div class="swiper-container">
            <div class="swiper-wrapper">
               <div class="swiper-slide"><img src="../images/room-6.jpg" alt="Urban Loft Room"></div>
               <div class="swiper-slide"><img src="../images/city-view.jpg" alt="City Skyline View"></div>
               <div class="swiper-slide"><img src="../images/kitchenette.jpg" alt="Kitchenette"></div>
               </div>
         ...
         <div class="package-details">
            ...
            <ul>
               ...
               <li>Amenities: City skyline view, Modern design, Smart TV, Kitchenette</li>
            </ul>
