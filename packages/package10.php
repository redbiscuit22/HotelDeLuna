...
$package = [];
$query = "SELECT id, package_name, price, description FROM packages WHERE id = '10'";
...
// Set availability (assuming Tropical Paradise Room is available for this example)
$packageAvailability = [];
...
<head>
   ...
   <title>Tropical Paradise Room - Package Details</title>
...
<body>
   ...
   <section class="home-packages">
      <h1 class="heading-title">Tropical Paradise Room Details</h1>
      
      <!-- Image Slider -->
      <?php if (!empty($package)): ?>
         <div class="swiper-container">
            <div class="swiper-wrapper">
               <div class="swiper-slide"><img src="../images/room-10.jpg" alt="Tropical Paradise Room"></div>
               <div class="swiper-slide"><img src="../images/tropical-decor.jpg" alt="Tropical Decor"></div>
               <div class="swiper-slide"><img src="../images/rainfall-shower.jpg" alt="Rainfall Shower"></div>
               </div>
         ...
         <div class="package-details">
            ...
            <ul>
               <li>Bed Type: King-size bed with mosquito net</li>
               <li>Occupancy: 2 adults</li>
               <li>Amenities: Tropical decor, Rainfall shower, Pool access</li>
            </ul>
            ...
            <ul>
               ...
               <li>Poolside drink vouchers</li>
               <li>Free use of floaters</li>
            </ul>
