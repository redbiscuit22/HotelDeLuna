...
// Connect to database
include '../connection.php'; // Path adjusted to root directory

// Fetch specific package from database
$package = [];
$query = "SELECT id, package_name, price, description FROM packages WHERE id = '1'";
...
// Set availability (assuming Serenity Suite is available for this example)
$packageAvailability = [];
...
<head>
   ...
   <title>Serenity Suite - Package Details</title>
...
<body>
   ...
   <section class="home-packages">
      <h1 class="heading-title">Serenity Suite Details</h1>
      
      <!-- Image Slider -->
      <?php if (!empty($package)): ?>
         <div class="swiper-container">
            <div class="swiper-wrapper">
               <div class="swiper-slide"><img src="../images/room-1.jpg" alt="Serenity Suite Room"></div>
               <div class="swiper-slide"><img src="../images/bathroom-1.jpg" alt="Serenity Suite Bathroom"></div>
               <div class="swiper-slide"><img src="../images/balcony-1.jpg" alt="Serenity Suite Balcony"></div>
            </div>
         ...
         <div class="package-details">
            ...
            <ul>
               ...
               <li>Occupancy: Up to 2 adults and 1 child</li>
               <li>Amenities: Wi-Fi, Smart TV, Minibar, Jacuzzi, Private Balcony</li>
            </ul>
            ...
            <ul>
               ...
               <li>Free access to spa and pool facilities</li>
               <li>10% discount on dining during stay</li>
            </ul>
