...
$package = [];
$query = "SELECT id, package_name, price, description FROM packages WHERE id = '12'";
...
// Set availability (assuming Lagoon Access Room is available for this example)
$packageAvailability = [];
...
<head>
   ...
   <title>Lagoon Access Room - Package Details</title>
...
<body>
   ...
   <section class="home-packages">
      <h1 class="heading-title">Lagoon Access Room Details</h1>
      
      <!-- Image Slider -->
      <?php if (!empty($package)): ?>
         <div class="swiper-container">
            <div class="swiper-wrapper">
               <div class="swiper-slide"><img src="../images/room-12.jpg" alt="Lagoon Access Room"></div>
               <div class="swiper-slide"><img src="../images/lagoon-access.jpg" alt="Lagoon Access"></div>
               <div class="swiper-slide"><img src="../images/floating-breakfast.jpg" alt="Floating Breakfast"></div>
              </div>
         ...
         <div class="package-details">
            ...
            <ul>
               ...
               <li>Amenities: Lagoon access, Floating breakfast, Air Conditioning</li>
            </ul>

            <!-- Inclusions and Ongoing Promotions -->
            <h4>Inclusions and Ongoing Promotions</h4>
            <ul>
               <li>Floating breakfast service</li>
               <li>Free kayak rental</li>
               <li>10% spa discount</li>
            </ul>
