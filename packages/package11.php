...
$package = [];
$query = "SELECT id, package_name, price, description FROM packages WHERE id = '11'";
...
// Set availability (assuming Cozy Book Nook Room is available for this example)
$packageAvailability = [];
...
<head>
   ...
   <title>Cozy Book Nook Room - Package Details</title>
...
<body>
   ...
   <section class="home-packages">
      <h1 class="heading-title">Cozy Book Nook Room Details</h1>
      
      <!-- Image Slider -->
      <?php if (!empty($package)): ?>
         <div class="swiper-container">
            <div class="swiper-wrapper">
               <div class="swiper-slide"><img src="../images/room-11.jpg" alt="Cozy Book Nook Room"></div>
               <div class="swiper-slide"><img src="../images/warm-lighting.jpg" alt="Warm Lighting"></div>
               <div class="swiper-slide"><img src="../images/bean-bags.jpg" alt="Bean Bags"></div>
                  </div>
         ...
         <div class="package-details">
            ...
            <ul>
               <li>Bed Type: Double bed</li>
               <li>Occupancy: 2 adults</li>
               <li>Amenities: Warm lighting, Bean bags, Reading nook, Wi-Fi</li>
            </ul>

            <!-- Inclusions and Ongoing Promotions -->
            <h4>Inclusions and Ongoing Promotions</h4>
            <ul>
               <li>Complimentary pastries & coffee</li>
               <li>Board game access</li>
