...
$package = [];
$query = "SELECT id, package_name, price, description FROM packages WHERE id = '5'";
...
// Set availability (assuming Mountain Peak Villa is available for this example)
$packageAvailability = [];
...
<head>
   ...
   <title>Mountain Peak Villa - Package Details</title>
...
<body>
   ...
   <section class="home-packages">
      <h1 class="heading-title">Mountain Peak Villa Details</h1>
      
      <!-- Image Slider -->
      <?php if (!empty($package)): ?>
         <div class="swiper-container">
            <div class="swiper-wrapper">
               <div class="swiper-slide"><img src="../images/mountain-villa.jpg" alt="Mountain Peak Villa"></div>
               <div class="swiper-slide"><img src="../images/mountain-view.jpg" alt="Mountain View"></div>
               <div class="swiper-slide"><img src="../images/fireplace.jpg" alt="Fireplace"></div>
               </div>
         ...
         <div class="package-details">
            ...
            <ul>
               ...
               <li>Occupancy: Up to 4 persons</li>
               <li>Amenities: Fireplace, Mountain View, Private Veranda, Bathtub</li>
            </ul>

            <!-- Inclusions and Promotions -->
            <h4>Inclusions and Ongoing Promotions</h4>
            <ul>
               <li>Free mountain hike guide</li>
               <li>Complimentary breakfast for four</li>
               <li>10% off on massage services</li>
            </ul>
