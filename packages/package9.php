...
$package = [];
$query = "SELECT id, package_name, price, description FROM packages WHERE id = '9'";
...
// Set availability (assuming Executive Skyline Suite is available for this example)
$packageAvailability = [];
...
<head>
   ...
   <title>Executive Skyline Suite - Package Details</title>
...
<body>
   ...
   <section class="home-packages">
      <h1 class="heading-title">Executive Skyline Suite Details</h1>
      
      <!-- Image Slider -->
      <?php if (!empty($package)): ?>
         <div class="swiper-container">
            <div class="swiper-wrapper">
               <div class="swiper-slide"><img src="../images/room-9.jpg" alt="Executive Skyline Suite"></div>
               <div class="swiper-slide"><img src="../images/executive-workspace.jpg" alt="Workspace Area"></div>
               <div class="swiper-slide"><img src="../images/city-view.jpg" alt="City View"></div>
               </div>
         ...
         <div class="package-details">
            ...
            <ul>
               ...
               <li>Amenities: Workspace, City View, High-speed Wi-Fi, Nespresso machine</li>
            </ul>
            ...
            <ul>
               ...
               <li>20% off business center use</li>
            </ul>
